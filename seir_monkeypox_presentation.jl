...
# ╔═╡ 74ea4146-01e7-11ed-0034-5b48e2ef4503
using Agents, Random, Distributions, StatsBase, Plots, Graphs, GraphPlot

# ╔═╡ e26a8dd3-e7cc-4e12-959c-2a7dcd4b1a17
begin
	include("seir_monkeypox.jl")
	
	md"""
	### SEIR MonkeyPox - A model
	"""
end

# ╔═╡ 5a2cbd08-6bbc-41e3-8a18-b3bf988e2f0b
model = SEIR_monkeypox(
	r=0.2, 
	p=0.21,
	prop_SS0 = 0.013,
	prop_BS0 = 0.008,
...
# ╔═╡ 7adae95d-d49f-47de-be9c-fcd7a087f917
generate_network!(model)

# ╔═╡ 13865cac-46e0-43d6-a3b3-2c1cb8c18d44
begin
	mdata = [:num_infected, :num_recovered, :num_dead]
	_, mdf = run!(model, dummystep, SEIR_step!, 2000; mdata=mdata)
end

# ╔═╡ 26c0d429-8737-42a9-b0fc-350ada62b318
histogram(
	degree(model.network),
	legend=false,
	xlabel="# of partners"
)

# ╔═╡ bec70001-f5d9-4857-aa77-5d4e2cfe7060
begin
	plot(
		mdf.step, 
		mdf.num_infected,
	...
	plot!(mdf.step, mdf.num_recovered, color="green")
	plot!(mdf.step, mdf.num_dead, color="red")
end

# ╔═╡ 172568e6-1cd9-41b7-b19c-af2dc974381d
model.cumulative_infection

# ╔═╡ b4b867c1-5602-4565-b65d-e4cc74b92df8
model.num_dead

# ╔═╡ 419eeca9-5a0f-44f2-9283-07d13471a827
model.num_dead / model.cumulative_infection
...
git-tree-sha1 = "5335ee46f18a4e14ae3680400e09679cedcad1c6"
